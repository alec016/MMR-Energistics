...
public class BlockRegistration {
  ...
  public static final DeferredBlock<MEBlock> ME_INPUT_BUS =
      BLOCKS.register(MEHatchSize.ME_INPUT_BUS.getSerializedName(), () -> new MEItemBusBlock(MEHatchSize.ME_INPUT_BUS));
  public static final DeferredBlock<MEBlock> ME_OUTPUT_BUS =
      BLOCKS.register(MEHatchSize.ME_OUTPUT_BUS.getSerializedName(), () -> new MEItemBusBlock(MEHatchSize.ME_OUTPUT_BUS));
  ...
  public static final DeferredBlock<MEBlock> ME_ADVANCED_OUTPUT_BUS =
      BLOCKS.register(MEHatchSize.ME_ADVANCED_OUTPUT_BUS.getSerializedName(), () -> new MEItemBusBlock(MEHatchSize.ME_ADVANCED_OUTPUT_BUS));
