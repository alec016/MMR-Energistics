...
public class MEOutputExperienceHatchEntity extends MEEntity {
  ...
  private class RequestActionSource extends MachineSource {
    ...
    RequestActionSource(final MEOutputExperienceHatchEntity machine, IActionHost host) {
      super(host);
  ...
  private class RequestContext {
    ...
    public int getPriority() {
      return MEOutputExperienceHatchEntity.this.getPriority();
    }
  }
  ...
  private class Ticker implements IGridTickable {
    ...
    public TickingRequest getTickingRequest(IGridNode node) {
      return new TickingRequest(TickRates.Interface, !MEOutputExperienceHatchEntity.this.hasWorkToDo());
    }

    public TickRateModulation tickingRequest(IGridNode node, int ticksSinceLastCall) {
      if (!MEOutputExperienceHatchEntity.this.getMainNode().isActive()) {
        return TickRateModulation.SLEEP;
      } else {
        boolean couldDoWork = MEOutputExperienceHatchEntity.this.updateStorage();
        return MEOutputExperienceHatchEntity.this.hasWorkToDo() ? (couldDoWork ? TickRateModulation.URGENT : TickRateModulation.SLOWER) : TickRateModulation.SLEEP;
      }
    }
  }
}
