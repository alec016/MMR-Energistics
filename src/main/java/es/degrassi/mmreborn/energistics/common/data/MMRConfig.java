...
public class MMRConfig {
  ...
  public double idlePowerDrainOnConnected(MEHatchSize size) {
    return switch (size) {
      ...
      case ME_INPUT_HATCH, ME_INPUT_CHEMICAL_HATCH -> ME_INPUT_HATCH_size.get();
      case ME_ADVANCED_INPUT_HATCH, ME_ADVANCED_INPUT_CHEMICAL_HATCH -> ME_ADVANCED_INPUT_HATCH_size.get();
      case ME_OUTPUT_HATCH, ME_OUTPUT_CHEMICAL_HATCH -> ME_OUTPUT_HATCH_size.get();
      case ME_ADVANCED_OUTPUT_HATCH, ME_ADVANCED_OUTPUT_CHEMICAL_HATCH -> ME_ADVANCED_OUTPUT_HATCH_size.get();
    };
  }
}
