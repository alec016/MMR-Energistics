...
@Getter
public class MEInputHatchContainer extends GridConnectedContainer<MEInputHatchEntity> {
  ...
  public static final MenuType<MEInputHatchContainer> ADVANCED_TYPE = MenuTypeBuilder
      .create(MEInputHatchContainer::new, MEInputHatchEntity.class)
      .build(ModularMachineryRebornEnergistics.rl("advanced_input_hatch"));

  protected MEInputHatchContainer(int containerId, Inventory inv, MEInputHatchEntity entity) {
