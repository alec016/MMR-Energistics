...
public class MEInputChemicalHatchContainer extends GridConnectedContainer<MEInputChemicalHatchEntity> {
  ...
  public static final MenuType<MEInputChemicalHatchContainer> TYPE = MenuTypeBuilder
      .create(MEInputChemicalHatchContainer::new, MEInputChemicalHatchEntity.class)
      .build(ModularMachineryRebornEnergistics.rl("input_chemical_hatch"));
  public static final MenuType<MEInputChemicalHatchContainer> ADVANCED_TYPE = MenuTypeBuilder
      .create(MEInputChemicalHatchContainer::new, MEInputChemicalHatchEntity.class)
      .build(ModularMachineryRebornEnergistics.rl("advanced_input_chemical_hatch"));

  protected MEInputChemicalHatchContainer(int containerId, Inventory inv, MEInputChemicalHatchEntity entity) {
