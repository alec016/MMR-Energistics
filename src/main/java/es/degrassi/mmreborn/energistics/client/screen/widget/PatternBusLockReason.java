...
public class PatternBusLockReason implements ICompositeWidget {
  @Setter
  protected boolean visible = false;
  protected int x;
  protected int y;

  private final MEPatternBusScreen screen;

  public PatternBusLockReason(MEPatternBusScreen screen) {
    this.screen = screen;
  }
